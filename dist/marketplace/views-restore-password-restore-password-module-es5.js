...
var RestorePasswordModule = /** @class */ (function () {
    function RestorePasswordModule() {
    }
...
var RestorePasswordComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RestorePasswordComponent, _super);
    function RestorePasswordComponent(activatedRoute, router, translate, notificationService, verificationsService) {
        ...
        _this.failed = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](false);
        _this.initForm();
        return _this;
    }
    RestorePasswordComponent.prototype.submit = function (_a) {
        var _this = this;
        var password = _a.password;
        this.submitBtnDissabled.next(true);
        this.verificationsService.restore(this.email, this.token, password)
            .subscribe(function () {
            _this.notificationService.open('Password.Successful');
            _this.submitBtnDissabled.next(false);
            _this.router.navigate(['/sign-in']);
        }, function () { return _this.submitBtnDissabled.next(false); });
    };
    RestorePasswordComponent.prototype.initForm = function () {
    ...
    RestorePasswordComponent.prototype.verifyToken = function () {
        var _this = this;
        ...
        this.verificationsService.verifyToken(this.email, this.token)
            .subscribe(function () {
            // do nothing
        }, function () { return _this.failed.next(true); });
    };
    RestorePasswordComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=views-restore-password-restore-password-module-es5.js.map