...
let DropdownComponent = class DropdownComponent extends _ngx_formly_core__WEBPACK_IMPORTED_MODULE_2__["FieldType"] {
    get value() {
...
let CommonInfoService = class CommonInfoService {
    ...
    getCountries() {
        return this.httpClient
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => data.map(({ name, numericCode, alpha2Code }) => ({ name, numericCode, alpha2Code }))));
    }
};
CommonInfoService.ctorParameters = () => [
...
//# sourceMappingURL=default~views-cart-cart-module~views-complete-profile-profile-module~views-profile-profile-module~vi~be87c225-es2015.js.map