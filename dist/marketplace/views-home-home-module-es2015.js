...
let SongsheetTopResolver = class SongsheetTopResolver {
...
SongsheetTopResolver.ctorParameters = () => [
...
let HomeComponent = class HomeComponent {
    constructor(breakpointObserver, changeDetectorRef, songsheetService, activatedRoute) {
    ...
    ngOnInit() {
        this.isMobile = this.breakpointObserver.observe('(max-width: 575px)')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((val) => val.matches), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])());
        this.cardsRowConfig = this.isMobile
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((isMobile) => {
            return {
                variableWidth: true,
                slidesToScroll: 2,
                swipe: true,
        ...
        this.subscription.add(this.featuredFilters
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["skip"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])((filters) => this.songsheetService.topList(filters)))
