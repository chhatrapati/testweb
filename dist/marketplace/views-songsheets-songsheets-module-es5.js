...
var ArrayUppercasePipe = /** @class */ (function () {
    function ArrayUppercasePipe() {
    }
    ArrayUppercasePipe.prototype.transform = function (items) {
        items.forEach(function (item, index) { return items[index] = item.toUpperCase(); });
        return items;
    };
...
var SearchResultsTypesPipe = /** @class */ (function () {
    function SearchResultsTypesPipe() {
    }
    SearchResultsTypesPipe.prototype.transform = function (value) {
        var typesString = value
            .filter(function (s) { return s.count > 0; })
            .map(function (s) { return s.count + " " + _core_enums_other_files_types__WEBPACK_IMPORTED_MODULE_2__["OtherFilesTypes"][s.type] + (s.count > 1 ? 's' : '') + ", "; })
            .join('');
...
var GenresResolver = /** @class */ (function () {
    function GenresResolver(genresService) {
        this.genresService = genresService;
    }
    GenresResolver.prototype.resolve = function (route, state) {
        return this.genresService.getGenres();
    };
    GenresResolver.ctorParameters = function () { return [
...
var SongsheetResolver = /** @class */ (function () {
    function SongsheetResolver(songsheetsService, router) {
        this.songsheetsService = songsheetsService;
        this.router = router;
    }
    SongsheetResolver.prototype.resolve = function (route, state) {
        var _this = this;
        var songsheetId = route.params.id;
        return this.songsheetsService.getSongsheet(songsheetId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            if (err.status === 404) {
    ...
    SongsheetResolver.ctorParameters = function () { return [
...
var SongsheetsResolver = /** @class */ (function () {
    function SongsheetsResolver(songsheetsService) {
        this.songsheetsService = songsheetsService;
    }
    SongsheetsResolver.prototype.resolve = function (route, state) {
        var filtersDefault = _app_constants__WEBPACK_IMPORTED_MODULE_3__["DEFAULT_FILTERS"];
        var _a = route.queryParams, search = _a.search, sortBy = _a.sortBy, direction = _a.direction, genres = _a.genres, fileTypes = _a.fileTypes;
        if (search) {
    ...
    SongsheetsResolver.ctorParameters = function () { return [
...
var GenresService = /** @class */ (function () {
    function GenresService(apiUrl, httpClient) {
        this.apiUrl = apiUrl;
        this.httpClient = httpClient;
        this.endpoint = '/songsheets';
    }
    Object.defineProperty(GenresService.prototype, "apiEndpoint", {
        get: function () {
    ...
    GenresService.prototype.getGenres = function () {
        return this.httpClient
            ...
            var genres = Array();
            keys.forEach(function (key) { return genres.push({ id: parseInt(key, 10), name: data.data[key] }); });
            return genres;
        }));
    };
    GenresService.ctorParameters = function () { return [
...
var SongsheetDetailsComponent = /** @class */ (function () {
    function SongsheetDetailsComponent(activatedRoute, cartService, router, sessionStorage) {
    ...
    SongsheetDetailsComponent.prototype.ngOnInit = function () {
        this.initOrder();
    };
    SongsheetDetailsComponent.prototype.initOrder = function () {
        this.songsheet = this.activatedRoute.snapshot.data.songsheet;
    };
    Object.defineProperty(SongsheetDetailsComponent.prototype, "instruments", {
        get: function () {
            if (!this.songsheet ||
            ...
            var contentToShow = this.songsheet.genres.concat(this.songsheet.instruments);
    ...
    SongsheetDetailsComponent.prototype.onAddToCart = function (id) {
        var _this = this;
        this.sessionStorage.userChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (u) { return (Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["iif"])(function () { return !!u; }, _this.cartService.addToCart(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () { return _this.cartService.refresh(); })), Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () { return _this.router.navigate(['/sign-in'], { queryParams: { songsheet: id } }); })))); }))
            .subscribe();
    };
    SongsheetDetailsComponent.ctorParameters = function () { return [
...
var SongsheetsComponent = /** @class */ (function () {
    function SongsheetsComponent(activatedRoute, router, songsheetsService) {
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.songsheetsService = songsheetsService;
        ...
        var genres = activatedRoute.snapshot.data.genres;
        this.genres = genres;
        var songsheets = this.activatedRoute.snapshot.data.songsheets;
        if (songsheets) {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), songsheets = _b[0], pagination = _b[1];
            return songsheets.length >= pagination.totalCount;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["share"])());
    }
    SongsheetsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.activatedRoute.queryParamMap
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(100), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (_a) {
            var params = _a.params;
            return !!params.fileTypes && !params.fileTypes.includes('Songsheet');
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () { return _this.filtersForm.get('genre'); }))
            .subscribe(function (c) { return c.disable(); });
        this.activatedRoute.queryParamMap
            .subscribe(function (paramMap) {
            _this.updateFilter(paramMap);
        });
        this.filtersForm.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(100), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (control) { return _this.filtersForm.controls.genre.valueChanges; }))
            .subscribe(function (genre) {
            if (genre) {
                var item_1 = _this.genres.find(function (x) { return x.name === genre; });
                if (item_1) {
                    // In case if element alread exists - remove it from filter
                    if (_this.choosenGenres.find(function (x) { return x === item_1; })) {
                        var index = _this.choosenGenres.indexOf(item_1);
                        if (index !== -1) {
                            _this.choosenGenres.splice(index, 1);
                        }
                        // If there is no genres - remove it from url string
                        if (_this.choosenGenres.length < 1) {
                            _this.updateQueryParams({ 'genres': null });
                        }
                        else {
                            _this.updateQueryParams({ 'genres': JSON.stringify(_this.choosenGenres.map(function (x) { return x.id; })) });
                        }
                    }
                    else {
                        _this.choosenGenres.push(item_1);
                        _this.updateQueryParams({ 'genres': JSON.stringify(_this.choosenGenres.map(function (x) { return x.id; })) });
                    }
                }
            }
        ...
        this.filtersForm.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(100), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () { return _this.filtersForm.get('type').valueChanges; }))
            .subscribe(function (type) {
            if (type) {
                var item_2 = _this.itemTypes.find(function (t) { return t.name === type; });
                if (item_2) {
                    if (_this.chosenItemTypes.find(function (x) { return x === item_2; })) {
                        var index = _this.chosenItemTypes.indexOf(item_2);
                        if (index !== -1) {
                            _this.chosenItemTypes.splice(index, 1);
                        }
                    }
                    else {
                        _this.chosenItemTypes.push(item_2);
                        _this.updateQueryParams({ 'fileTypes': JSON.stringify(_this.chosenItemTypes.map(function (x) { return x.id; })) });
                    }
                }
                _this.filtersForm.get('genre').setValue(null);
                if (_this.chosenItemTypes.length < 1) {
                    var queryParams = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.activatedRoute.snapshot.queryParams, { 'fileTypes': null });
                    _this.updateQueryParams(queryParams);
                    _this.filtersForm.get('genre').enable();
                }
                else {
                    var queryParams = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.activatedRoute.snapshot.queryParams, { 'fileTypes': JSON.stringify(_this.chosenItemTypes.map(function (x) { return x.id; })) });
                    if (!_this.chosenItemTypes.find(function (v) { return v.id === 'Songsheet'; })) {
                        queryParams.genres = null;
                        _this.filtersForm.get('genre').disable();
                        _this.choosenGenres.splice(0);
                    }
                    else {
                        _this.filtersForm.get('genre').enable();
                    }
        ...
        this.filtersForm.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(100), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (control) { return _this.filtersForm.controls.sortBy.valueChanges; }))
            .subscribe(function (sortBy) {
            if (sortBy) {
                var filterOrder = _this.order.get(sortBy);
                var direction = filterOrder.order;
                var key = filterOrder.column;
                _this.updateQueryParams({ 'sortBy': key, direction: direction });
            }
        });
    };
    SongsheetsComponent.prototype.handleLoadMore = function () {
        var nextOffset = this.pagination.getValue().nextOffset;
        if (!nextOffset) {
            return;
        }
        var paramMap = this.activatedRoute.snapshot.queryParamMap;
        var search = paramMap.get('search') ? paramMap.get('search') : '';
        var direction = paramMap.get('direction') ? paramMap.get('direction') : '';
        var sortBy = paramMap.get('sortBy') ? paramMap.get('sortBy') : '';
        var filters = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.filter.getValue(), _app_constants__WEBPACK_IMPORTED_MODULE_7__["DEFAULT_FILTERS"]);
        ...
        filters.genres = this.choosenGenres.map(function (x) { return x.id; });
        filters.fileTypes = this.chosenItemTypes.map(function (x) { return x.id; });
        this.loadData(filters);
    };
    SongsheetsComponent.prototype.updateFilter = function (paramMap) {
        var search = paramMap.get('search') ? paramMap.get('search') : '';
        var direction = paramMap.get('direction') ? paramMap.get('direction') : '';
        var sortBy = paramMap.get('sortBy') ? paramMap.get('sortBy') : '';
        var filters = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.filter.getValue(), _app_constants__WEBPACK_IMPORTED_MODULE_7__["DEFAULT_FILTERS"]);
    ...
    SongsheetsComponent.prototype.updateQueryParams = function (queryParams) {
        return this.router.navigate(['/music-scores'], { queryParams: queryParams, queryParamsHandling: 'merge' });
    };
    SongsheetsComponent.prototype.loadData = function (filters) {
        var _this = this;
        this.filter.next(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, filters));
        this.isLoadingData.next(true);
        this.songsheetsService.findList(filters)
            .subscribe(function (_a) {
            var items = _a.items, pagination = _a.pagination, itemsCount = _a.itemsCount;
            _this.list.next(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.list.getValue(), items));
            _this.isLoadingData.next(false);
            _this.searchedTypesResult.next(itemsCount);
            _this.pagination.next(pagination);
        }, function () { return _this.isLoadingData.next(false); });
    };
    SongsheetsComponent.prototype.getGenres = function (genres) {
        var _this = this;
        var urlGenres = JSON.parse(genres);
        this.choosenGenres = [];
        urlGenres.forEach(function (x) { return _this.choosenGenres.push(_this.genres.find(function (y) { return y.id === parseInt(x, 10); })); });
    };
    SongsheetsComponent.prototype.getFileTypes = function (types) {
        var _this = this;
        var urlFileTypes = JSON.parse(types);
        this.chosenItemTypes = [];
        urlFileTypes.forEach(function (x) { return _this.chosenItemTypes.push(_this.itemTypes.find(function (y) { return y.id === x; })); });
        if (urlFileTypes.length > 0 && !urlFileTypes.includes('Songsheet')) {
            this.choosenGenres = [];
        }
    };
    SongsheetsComponent.prototype.initForm = function () {
        ...
        var paramMap = this.activatedRoute.snapshot.queryParamMap;
        var genres = paramMap.get('genres') ? paramMap.get('genres') : '';
        var fileTypes = paramMap.get('fileTypes') ? paramMap.get('fileTypes') : '';
        if (genres) {
        ...
        this.filtersFormConfig = Object(_songsheets_configs__WEBPACK_IMPORTED_MODULE_8__["getFiltersForm"])(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.genres.map(function (x) { return x.name; })), tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.order.keys()), this.itemTypes.map(function (i) { return i.name; }), this.choosenGenres, this.chosenItemTypes);
    };
    SongsheetsComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var SongsheetsModule = /** @class */ (function () {
    function SongsheetsModule() {
    }
...
//# sourceMappingURL=views-songsheets-songsheets-module-es5.js.map