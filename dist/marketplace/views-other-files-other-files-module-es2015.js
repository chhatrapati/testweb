...
let MarkedDirectiveModule = class MarkedDirectiveModule {
};
...
let MarkedDirective = class MarkedDirective {
    constructor(elementRef, markedService) {
...
MarkedDirective.ctorParameters = () => [
...
ImageRequestModel.ctorParameters = () => [
    { type: undefined }
];
...
let OtherFileResolver = class OtherFileResolver {
    constructor(ofService, router) {
        this.ofService = ofService;
        this.router = router;
    }
    resolve(route, state) {
        const otherFileId = route.params.id;
        return this.ofService.getOtherFile(otherFileId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])((err) => {
            if (err.status === 404) {
...
OtherFileResolver.ctorParameters = () => [
...
const removeMarkdown = __webpack_require__(/*! remove-markdown */ "./node_modules/remove-markdown/index.js");
let MarkedService = MarkedService_1 = class MarkedService {
    get renderer() {
    ...
    static heading(text, level, raw, slugger) {
...
let OtherFilesService = class OtherFilesService {
    ...
    getOtherFile(id) {
        return this.httpClient.get(`${this.apiEndpoint}/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => new _models_otherfile_otherfile_model__WEBPACK_IMPORTED_MODULE_5__["OtherFileModel"](data.data)));
    }
    getPrivateFile(filePath) {
        return this.httpClient.get(`${filePath}`, { responseType: 'blob' });
    }
};
OtherFilesService.ctorParameters = () => [
...
let OtherFilesRoutingModule = class OtherFilesRoutingModule {
};
...
let OtherFilesComponent = class OtherFilesComponent {
    constructor(router, ofService, document, activatedRoute) {
        this.router = router;
        this.ofService = ofService;
...
OtherFilesComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let OtherFilesModule = class OtherFilesModule {
};
...
//# sourceMappingURL=views-other-files-other-files-module-es2015.js.map