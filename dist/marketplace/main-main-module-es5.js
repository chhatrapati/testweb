...
var PASSWORD_PATTERN = /^(?=.*[0-9])(?=.*[a-zA-Z])(?=.*[A-Z])([a-zA-Z0-9\s\S_-]+)/;
var PHONE_MIN_LENGTH = 6;
var SEARCH_QUERY_LENGTH = 3;
var PHONE_MAX_LENGTH = 16;
var PHONE_PATTERN = /^\+[0-9]\d{5,15}$/;
var NOT_SPACES_ONLY = /^(?!\s+$).+/;
var ALPHANUMERIC_PUNCTUATION = /^[a-zA-Z0-9 .-]*$/;
var NUMERIC = /^[0-9]*$/;
var ALPHANUMERIC = /^[a-zA-Z0-9 ]*$/;
// tslint:disable-next-line:max-line-length
var CARD_NUMBER_PATTERN = /^(?:(4[0-9]{12}(?:[0-9]{3})?)|(5[1-5][0-9]{14})|(6(?:011|5[0-9]{2})[0-9]{12})|(3[47][0-9]{13})|(3(?:0[0-5]|[68][0-9])[0-9]{11})|((?:2131|1800|35[0-9]{3})[0-9]{11}))$/;
var CARD_EXPIRATION_PATTERN = /^(0[1-9]|1[0-2])\/?([0-9]{4}|[0-9]{2})$/;
// tslint:disable-next-line:max-line-length
...
var MenuProfileComponent = /** @class */ (function () {
    function MenuProfileComponent(usersService, avatarService) {
    ...
    MenuProfileComponent.prototype.ngOnChanges = function (_a) {
        var user = _a.user;
...
var MenuProfileModule = /** @class */ (function () {
    function MenuProfileModule() {
    }
...
var imgPlaceholder = 'assets/img/image-placeholder-3.svg';
var PhotoComponent = /** @class */ (function () {
    function PhotoComponent(sanitizer) {
    ...
    PhotoComponent.prototype.ngOnChanges = function (_a) {
        var photo = _a.photo;
    ...
    PhotoComponent.prototype.saveImage = function (image) {
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(sessionStorage, router) {
...
var ProviderGuard = /** @class */ (function () {
    function ProviderGuard(sessionStorage, router) {
        this.sessionStorage = sessionStorage;
        this.router = router;
    }
    ProviderGuard.prototype.canActivate = function (next, state) {
    ...
    ProviderGuard.ctorParameters = function () { return [
        { type: _core_session_session_storage__WEBPACK_IMPORTED_MODULE_3__["SessionStorage"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var UnsubscribedGuard = /** @class */ (function () {
    function UnsubscribedGuard(router, sessionStorage) {
        this.router = router;
        this.sessionStorage = sessionStorage;
    }
    UnsubscribedGuard.prototype.canActivate = function (next, state) {
    ...
    UnsubscribedGuard.prototype.canLoad = function (route, segments) {
        var user = this.sessionStorage.userStorage;
        if (!user.isSubscribed) {
            this.router.navigate(['/subscription']);
            return;
    ...
    UnsubscribedGuard.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _core_session_session_storage__WEBPACK_IMPORTED_MODULE_3__["SessionStorage"] }
    ]; };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(breakpointObserver, renderer, elementRef, sessionStorage, cartService, platformId, document, router, activatedRoute, authService) {
        ...
        var search = this.activatedRoute.snapshot.queryParams.search;
        ...
        this.isLoggedIn = sessionStorage.userChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (u) { return !!u; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["shareReplay"])());
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.isMobile = this.breakpointObserver.observe('(max-width: 991px)')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (val) { return val.matches; }));
        var isOpenMenuSubscription = this.isOpenMenu
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["withLatestFrom"])(this.isMobile), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), isMobile = _b[1];
            return isMobile;
        }))
            .subscribe(function (_a) {
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 1), isOpenMenu = _b[0] /*, isMobile*/;
            isOpenMenu
                ? _this.renderer.addClass(_this.elementRef.nativeElement, 'locked')
                : _this.renderer.removeClass(_this.elementRef.nativeElement, 'locked');
            isOpenMenu
                ? _this.renderer.addClass(_this.document.body, 'locked')
                : _this.renderer.removeClass(_this.document.body, 'locked');
        });
        this.subscription.add(isOpenMenuSubscription);
        var searchSubscription = this.searchForm.get('search').valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(500))
            .subscribe(function (search) {
            if (search.length === 0) {
                _this.router.navigate(['/music-scores']);
            }
            if (search.length >= _app_constants__WEBPACK_IMPORTED_MODULE_10__["SEARCH_QUERY_LENGTH"]) {
                _this.router.navigate(['/music-scores'], { queryParams: { search: search }, queryParamsHandling: 'merge' });
            }
        });
        this.subscription.add(searchSubscription);
        var navigatiionStart = this.router.events
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_7__["NavigationStart"] && _this.isOpenMenu.getValue(); }))
            .subscribe(function (e) { return _this.closeMenu(); });
        this.subscription.add(navigatiionStart);
        this.subscription.add(this.cartService.initCart().subscribe());
        var userSubscription = this.currentUser
            .subscribe(function (u) { return u ?
            _this.cartService.refresh() :
            _this.cartService.clearCart(); });
        this.subscription.add(userSubscription);
        window.onorientationchange = function () {
            if (_this.isOpenMenu.getValue() === true) {
                _this.renderer.removeClass(_this.navBar.nativeElement, 'show');
                _this.isOpen();
            }
        };
    };
    ...
    HeaderComponent.prototype.onSearchCancelClick = function (event) {
        event.preventDefault();
        this.isSearchActive.next(!this.isSearchActive.getValue());
    ...
    HeaderComponent.prototype.closeMenu = function () {
        var _this = this;
        this.isMobile
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (r) { return !!r; }))
            .subscribe(function () {
            _this.renderer.removeClass(_this.navBar.nativeElement, 'show');
            _this.isOpenMenu.next(false);
        });
    };
    HeaderComponent.prototype.onNavClicked = function (event) {
        var _this = this;
        if (event === 'logout') {
    ...
    HeaderComponent.prototype.cartDropdownChange = function () {
...
var routes = [
    {
        ...
        children: [
            {
                path: '',
                loadChildren: function () { return Promise.all(/*! import() | views-home-home-module */[__webpack_require__.e("default~views-home-home-module~views-songsheets-songsheets-module"), __webpack_require__.e("views-home-home-module")]).then(__webpack_require__.bind(null, /*! ../views/home/home.module */ "./src/app/views/home/home.module.ts")).then(function (m) { return m.HomeModule; }); }
            },
            {
                path: '',
                loadChildren: function () { return Promise.all(/*! import() | views-docs-docs-module */[__webpack_require__.e("common"), __webpack_require__.e("views-docs-docs-module")]).then(__webpack_require__.bind(null, /*! ../views/docs/docs.module */ "./src/app/views/docs/docs.module.ts")).then(function (m) { return m.DocsModule; }); }
            },
            {
                path: 'sign-up',
                loadChildren: function () { return Promise.all(/*! import() | views-sign-up-sign-up-module */[__webpack_require__.e("default~views-complete-profile-profile-module~views-reset-password-reset-password-module~views-resto~d6d83d7f"), __webpack_require__.e("common"), __webpack_require__.e("views-sign-up-sign-up-module")]).then(__webpack_require__.bind(null, /*! ../views/sign-up/sign-up.module */ "./src/app/views/sign-up/sign-up.module.ts")).then(function (m) { return m.SignUpModule; }); },
                data: {
                    isFooterHidden: true
                }
            },
            {
                path: 'sign-in',
                loadChildren: function () { return Promise.all(/*! import() | views-sign-in-sign-in-module */[__webpack_require__.e("default~views-complete-profile-profile-module~views-reset-password-reset-password-module~views-resto~d6d83d7f"), __webpack_require__.e("common"), __webpack_require__.e("views-sign-in-sign-in-module")]).then(__webpack_require__.bind(null, /*! ../views/sign-in/sign-in.module */ "./src/app/views/sign-in/sign-in.module.ts")).then(function (m) { return m.SignInModule; }); },
                data: {
                    isFooterHidden: true
                }
            },
            {
                ...
                loadChildren: function () { return Promise.all(/*! import() | views-restore-password-restore-password-module */[__webpack_require__.e("default~views-complete-profile-profile-module~views-reset-password-reset-password-module~views-resto~d6d83d7f"), __webpack_require__.e("common"), __webpack_require__.e("views-restore-password-restore-password-module")]).then(__webpack_require__.bind(null, /*! ../views/restore-password/restore-password.module */ "./src/app/views/restore-password/restore-password.module.ts")).then(function (m) { return m.RestorePasswordModule; }); },
                data: {
                    isFooterHidden: true
                }
            },
            {
                path: 'reset-password',
                loadChildren: function () { return Promise.all(/*! import() | views-reset-password-reset-password-module */[__webpack_require__.e("default~views-complete-profile-profile-module~views-reset-password-reset-password-module~views-resto~d6d83d7f"), __webpack_require__.e("common"), __webpack_require__.e("views-reset-password-reset-password-module")]).then(__webpack_require__.bind(null, /*! ../views/reset-password/reset-password.module */ "./src/app/views/reset-password/reset-password.module.ts")).then(function (m) { return m.ResetPasswordModule; }); },
                data: {
                    isFooterHidden: true
                }
            },
            {
                path: 'confirm-email',
                loadChildren: function () { return Promise.all(/*! import() | views-verification-verification-module */[__webpack_require__.e("default~views-complete-profile-profile-module~views-reset-password-reset-password-module~views-resto~d6d83d7f"), __webpack_require__.e("common"), __webpack_require__.e("views-verification-verification-module")]).then(__webpack_require__.bind(null, /*! ../views/verification/verification.module */ "./src/app/views/verification/verification.module.ts")).then(function (m) { return m.VerificationModule; }); },
                data: {
                    isFooterHidden: true
                }
            },
            {
                path: 'subscription',
                loadChildren: function () { return Promise.all(/*! import() | views-subscription-subscription-module */[__webpack_require__.e("default~views-cart-cart-module~views-complete-profile-profile-module~views-profile-profile-module~vi~be87c225"), __webpack_require__.e("default~views-cart-cart-module~views-subscription-subscription-module"), __webpack_require__.e("default~views-profile-profile-module~views-subscription-subscription-module"), __webpack_require__.e("views-subscription-subscription-module")]).then(__webpack_require__.bind(null, /*! ../views/subscription/subscription.module */ "./src/app/views/subscription/subscription.module.ts")).then(function (m) { return m.SubscriptionModule; }); }
            },
            {
                path: 'complete-profile',
                loadChildren: function () { return Promise.all(/*! import() | views-complete-profile-profile-module */[__webpack_require__.e("default~views-complete-profile-profile-module~views-reset-password-reset-password-module~views-resto~d6d83d7f"), __webpack_require__.e("default~views-cart-cart-module~views-complete-profile-profile-module~views-profile-profile-module~vi~be87c225"), __webpack_require__.e("common"), __webpack_require__.e("views-complete-profile-profile-module")]).then(__webpack_require__.bind(null, /*! ../views/complete-profile/profile.module */ "./src/app/views/complete-profile/profile.module.ts")).then(function (m) { return m.ProfileModule; }); },
            ...
            {
                path: 'music-scores',
                loadChildren: function () { return Promise.all(/*! import() | views-songsheets-songsheets-module */[__webpack_require__.e("default~views-cart-cart-module~views-complete-profile-profile-module~views-profile-profile-module~vi~be87c225"), __webpack_require__.e("default~views-other-files-other-files-module~views-songsheets-songsheets-module"), __webpack_require__.e("default~views-home-home-module~views-songsheets-songsheets-module"), __webpack_require__.e("views-songsheets-songsheets-module")]).then(__webpack_require__.bind(null, /*! ../views/songsheets/songsheets.module */ "./src/app/views/songsheets/songsheets.module.ts")).then(function (m) { return m.SongsheetsModule; }); }
            },
            {
                path: 'profile',
                loadChildren: function () { return Promise.all(/*! import() | views-profile-profile-module */[__webpack_require__.e("default~views-cart-cart-module~views-complete-profile-profile-module~views-profile-profile-module~vi~be87c225"), __webpack_require__.e("default~views-profile-profile-module~views-subscription-subscription-module"), __webpack_require__.e("common"), __webpack_require__.e("views-profile-profile-module")]).then(__webpack_require__.bind(null, /*! ../views/profile/profile.module */ "./src/app/views/profile/profile.module.ts")).then(function (m) { return m.ProfileModule; }); },
                canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
            },
            {
                path: 'contact-us',
                loadChildren: function () { return Promise.all(/*! import() | views-contact-us-contact-us-module */[__webpack_require__.e("common"), __webpack_require__.e("views-contact-us-contact-us-module")]).then(__webpack_require__.bind(null, /*! ../views/contact-us/contact-us.module */ "./src/app/views/contact-us/contact-us.module.ts")).then(function (m) { return m.ContactUsModule; }); }
            },
            {
                path: 'cart',
                loadChildren: function () { return Promise.all(/*! import() | views-cart-cart-module */[__webpack_require__.e("default~views-cart-cart-module~views-complete-profile-profile-module~views-profile-profile-module~vi~be87c225"), __webpack_require__.e("default~views-cart-cart-module~views-subscription-subscription-module"), __webpack_require__.e("views-cart-cart-module")]).then(__webpack_require__.bind(null, /*! ../views/cart/cart.module */ "./src/app/views/cart/cart.module.ts")).then(function (m) { return m.CartModule; }); }
            },
            {
                path: '',
                loadChildren: function () { return Promise.all(/*! import() | views-other-files-other-files-module */[__webpack_require__.e("default~views-other-files-other-files-module~views-songsheets-songsheets-module"), __webpack_require__.e("views-other-files-other-files-module")]).then(__webpack_require__.bind(null, /*! ../views/other-files/other-files.module */ "./src/app/views/other-files/other-files.module.ts")).then(function (m) { return m.OtherFilesModule; }); },
...
var MainComponent = /** @class */ (function () {
    function MainComponent(activatedRoute, router) {
        this.activatedRoute = activatedRoute;
        this.router = router;
    }
...
var CartItemModel = /** @class */ (function () {
    ...
    Object.defineProperty(CartItemModel.prototype, "getInstruments", {
        get: function () {
            if (!this.instruments || !this.instruments.length) {
                return '';
            }
            var contentToShow = this.instruments;
            var contentToShowLength = contentToShow.length;
    ...
    Object.defineProperty(CartItemModel.prototype, "getGenres", {
        get: function () {
            if (!this.genres || !this.genres.length) {
                return '';
            }
            var contentToShow = this.genres;
            var contentToShowLength = contentToShow.length;
            return (contentToShowLength <= 4
                ? contentToShow
                : contentToShow.slice(0, 4).concat('and more')).join(' · ');
    ...
    CartItemModel.ctorParameters = function () { return [
        { type: undefined }
    ]; };
...
var CartModel = /** @class */ (function () {
    function CartModel(data) {
        ...
        this.items = data.items.map(function (i) { return new _cart_item_model__WEBPACK_IMPORTED_MODULE_0__["CartItemModel"](i); });
    }
    Object.defineProperty(CartModel.prototype, "showFilledCart", {
        get: function () {
    ...
    Object.defineProperty(CartModel.prototype, "orderDate", {
        get: function () {
            return Date.now();
        },
        enumerable: true,
    ...
    Object.defineProperty(CartModel.prototype, "itemsTypo", {
        get: function () {
    ...
    CartModel.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return CartModel;
}());
...
var PaymentBillingModel = /** @class */ (function () {
    function PaymentBillingModel(data) {
    ...
    PaymentBillingModel.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return PaymentBillingModel;
}());
var PaymentMethodModel = /** @class */ (function () {
    function PaymentMethodModel(data) {
        this.cardMask = data.cardMask;
        this.cardType = data.cardType;
    }
    PaymentMethodModel.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return PaymentMethodModel;
}());
var CartPaymentModel = /** @class */ (function () {
    function CartPaymentModel(data) {
        this.orderId = data.orderId;
        this.orderAmount = data.orderAmount;
        this.status = data.status;
        this.songsheets = data.songsheets.map(function (s) { return new _songsheet_songsheet_model__WEBPACK_IMPORTED_MODULE_0__["SongsheetModel"](s); });
        if (data.paymentMethod) {
            this.paymentMethod = new PaymentMethodModel(data.paymentMethod);
        }
    }
    CartPaymentModel.ctorParameters = function () { return [
        { type: undefined }
    ]; };
...
var SongsheetModel = /** @class */ (function () {
    function SongsheetModel(data) {
        this.id = data.id;
        this.name = data.name;
    ...
    Object.defineProperty(SongsheetModel.prototype, "getInstruments", {
        get: function () {
            if (!this.instruments ||
    ...
    Object.defineProperty(SongsheetModel.prototype, "getGenres", {
        get: function () {
            if (!this.genres ||
                !this.genres.length) {
                return '';
    ...
    SongsheetModel.ctorParameters = function () { return [
        { type: undefined }
    ]; };
...
var SubscriptionStatus = /** @class */ (function () {
    function SubscriptionStatus(subscriptionStatus) {
    ...
    SubscriptionStatus.ctorParameters = function () { return [
...
var AuthService = /** @class */ (function () {
    function AuthService(apiUrl, httpClient) {
        this.apiUrl = apiUrl;
        this.httpClient = httpClient;
        this.endpoint = '/sessions';
    }
    Object.defineProperty(AuthService.prototype, "apiEndpoint", {
        get: function () {
    ...
    AuthService.prototype.signIn = function (credentials) {
        return this.httpClient
            ...
            var data = _a.data;
            return new _core_session_app_user__WEBPACK_IMPORTED_MODULE_4__["AppUser"](data);
        }));
    };
    AuthService.prototype.getProfile = function () {
        return this.httpClient
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (_a) {
            var data = _a.data;
            return new _models_user_user_model__WEBPACK_IMPORTED_MODULE_6__["UserModel"](data);
        }));
    };
    AuthService.prototype.patchProfile = function (payload) {
        return this.httpClient
    ...
    AuthService.prototype.deletePhoto = function () {
        return this.httpClient
    ...
    AuthService.prototype.changePassword = function (payload) {
        var currentPassword = payload.currentPassword, _a = payload.password, password = _a.password, confirmPassword = _a.confirmPassword;
        return this.httpClient
            .put(this.apiUrl + "/users/me/password", { password: password, currentPassword: currentPassword, confirmPassword: confirmPassword });
    };
...
var CartService = /** @class */ (function () {
    function CartService(apiUrl, httpClient) {
        this.apiUrl = apiUrl;
        this.httpClient = httpClient;
        this.endpoint = '/cart';
    ...
    Object.defineProperty(CartService.prototype, "apiEndpoint", {
        get: function () {
            return [this.apiUrl, this.endpoint].join('');
        },
        enumerable: true,
    ...
    CartService.prototype.initCart = function () {
        ...
        return this.refresher
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function () { return _this.requestCart()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(undefined); })); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (data) { return _this.cartStorage.next(data); }));
    };
    CartService.prototype.refresh = function () {
        this.refresher.next();
    };
    CartService.prototype.requestCart = function () {
        return this.httpClient
            .get(this.apiEndpoint)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (cart) { return new _models_cart_cart_model__WEBPACK_IMPORTED_MODULE_5__["CartModel"](cart.data); }));
    };
    CartService.prototype.addToCart = function (songsheetId) {
        return this.httpClient
            .post(this.apiEndpoint, { songsheetId: songsheetId })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return new _models_cart_cart_item_model__WEBPACK_IMPORTED_MODULE_7__["CartItemModel"](data.data); }));
    };
    CartService.prototype.deleteFromCart = function (id) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]().set('songsheetId', id.toString());
        return this.httpClient
            .delete(this.apiEndpoint, { params: params });
    };
    CartService.prototype.clearCart = function () {
        this.cartStorage.next(undefined);
    };
    CartService.prototype.payFreeCart = function () {
        return this.httpClient
            .post(this.apiEndpoint + "/free", {})
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return new _models_cart_cart_payment_model__WEBPACK_IMPORTED_MODULE_8__["CartPaymentModel"](data.data); }));
    };
...
var UsersService = /** @class */ (function () {
    function UsersService(apiUrl, httpClient, sanitizer) {
        this.apiUrl = apiUrl;
        this.httpClient = httpClient;
        this.sanitizer = sanitizer;
        this.endpoint = '/users';
    }
    Object.defineProperty(UsersService.prototype, "apiEndpoint", {
        get: function () {
            return [this.apiUrl, this.endpoint].join('');
        },
        enumerable: true,
    ...
    UsersService.prototype.signUp = function (user) {
        return this.httpClient
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return new _models_user_user_model__WEBPACK_IMPORTED_MODULE_5__["UserModel"](response.data); }));
    };
    ...
    UsersService.prototype.setAvatar = function (originalImageId, thumbnailImageId) {
        return this.httpClient
            .put(this.apiEndpoint + "/me/avatar", { originalImageId: originalImageId, thumbnailImageId: thumbnailImageId });
    };
    UsersService.prototype.editProfile = function (profile) {
        return this.httpClient
            .patch(this.apiEndpoint + "/me/profile", profile)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return new _models_user_user_model__WEBPACK_IMPORTED_MODULE_5__["UserModel"](response.data); }));
    };
    UsersService.prototype.changePassword = function (passwordsPair) {
        return this.httpClient
    ...
    UsersService.prototype.deleteAccount = function () {
        return this.httpClient
            .delete(this.apiEndpoint + "/me");
    };
    UsersService.prototype.getFile = function (filePath) {
        var _this = this;
    ...
    UsersService.prototype.checkSubscription = function () {
        return this.httpClient.get(this.apiEndpoint + "/me/subscription")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return new _models_subscriptions_subscription_status__WEBPACK_IMPORTED_MODULE_7__["SubscriptionStatus"](response.data); }));
    };
