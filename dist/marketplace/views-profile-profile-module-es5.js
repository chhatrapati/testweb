...
function getCurrentYearLastDigits() {
    ...
    var lastDigits = fullYear.slice(fullYear.length - 2);
...
function createParams(params, objectParams) {
    if (objectParams) {
        Object.keys(objectParams).forEach(function (key) {
            if (Array.isArray(objectParams[key])) {
                objectParams[key].forEach(function (item, index) {
...
/* harmony import */ var _url_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./url-filter */ "./src/app/libs/tables/url-filter.ts");



var CommonUrlFilter = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](CommonUrlFilter, _super);
    function CommonUrlFilter(router) {
        return _super.call(this, router) || this;
    }
    CommonUrlFilter.prototype.setSorting = function (sort) {
    ...
    CommonUrlFilter.prototype.setPage = function (pageEvent) {
    ...
    CommonUrlFilter.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }
    ]; };
    return CommonUrlFilter;
}(_url_filter__WEBPACK_IMPORTED_MODULE_2__["UrlFilter"]));
...
var Table = /** @class */ (function (_super) {
    ...
    function Table(dataService, filterChanges) {
        var _this = _super.call(this) || this;
        _this.dataService = dataService;
        _this.filterChanges = filterChanges;
        _this.refresher = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        _this.pending = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](false);
        _this.length = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](0);
        _this.pagination = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        return _this;
    }
    Object.defineProperty(Table.prototype, "isPending", {
        get: function () {
    ...
    Object.defineProperty(Table.prototype, "lengthChanges", {
        get: function () {
    ...
    Object.defineProperty(Table.prototype, "metaChanges", {
        get: function () {
    ...
    Table.itemChanges = function (subject) {
        return subject.asObservable()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])());
    };
    Table.prototype.connect = function (collectionViewer) {
        var _this = this;
        var stopPending = function () { return _this.pending.next(false); };
        var filterChanges = this.filterChanges.pipe(
        // store current filter
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (f) { return _this.currentFilter = f; }));
        var refreshEmitted = this.refresher.pipe(
        // emit last value of filter
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function () { return _this.currentFilter; }));
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(filterChanges, refreshEmitted)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () { return _this.pending.next(true); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (filters) { return _this.dataService.findList(filters); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(stopPending, stopPending), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(stopPending), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (res) {
            _this.length.next(res.pagination.totalCount);
            _this.pagination.next(res.pagination);
    ...
    Table.prototype.disconnect = function (collectionViewer) {
        /* do nothing */
    };
...
var UrlFilter = /** @class */ (function () {
    function UrlFilter(router) {
        this.router = router;
    }
    UrlFilter.prototype.setKey = function (key, value) {
        var _a, _b;
    ...
    UrlFilter.prototype.setKeys = function (values, merge) {
        if (merge === void 0) { merge = true; }
        var minSearchLength = 1;
        var params = Object.keys(values).reduce(function (result, key) {
    ...
    UrlFilter.prototype.setAll = function (queryParams, merge) {
        if (merge === void 0) { merge = true; }
        var queryParamsHandling = merge ? 'merge' : null;
        return this.router.navigate([], {
            queryParams: queryParams, queryParamsHandling: queryParamsHandling
        });
    };
    UrlFilter.ctorParameters = function () { return [
...
var SongsheetOrderModel = /** @class */ (function () {
    function SongsheetOrderModel(data) {
        this.id = data.id;
        this.name = data.name;
    ...
    SongsheetOrderModel.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return SongsheetOrderModel;
}());
...
var OrdersService = /** @class */ (function () {
    function OrdersService(apiUrl, httpClient) {
        this.apiUrl = apiUrl;
        this.httpClient = httpClient;
        this.endpoint = '/orders/songsheets';
    }
    Object.defineProperty(OrdersService.prototype, "apiEndpoint", {
        get: function () {
    ...
    OrdersService.prototype.findList = function (filter) {
        ...
        return this.httpClient
            ...
            return {
                ...
                data: data.map(function (i) { return new _models_songsheet_songsheet_order_model__WEBPACK_IMPORTED_MODULE_5__["SongsheetOrderModel"](i); }),
            };
        }), 
        // ignore error
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])({ data: [], pagination: { totalCount: 0 } }); }));
    };
    OrdersService.prototype.downloadOrderSongsheets = function (id) {
        var url = [this.apiUrl, 'orders', id, 'songsheets', 'download'].join('/');
        return this.httpClient
            .get(url, { responseType: 'blob' });
    };
    OrdersService.prototype.getOrderById = function (id) {
        var url = [this.apiUrl, 'orders', id].join('/');
        return this.httpClient
            .get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return new _models_cart_cart_payment_model__WEBPACK_IMPORTED_MODULE_8__["CartPaymentModel"](data.data); }));
    };
    ...
    return [
        {
            ...
            validators: {
                required: function (ctrl) { return ctrl.value && !!ctrl.value.trim().length; }
            },
            validation: {
                messages: {
...
var ProfileEditComponent = /** @class */ (function () {
    function ProfileEditComponent(authService, imagesService, toastrService, sessionStorage, modalService) {
    ...
    ProfileEditComponent.prototype.submit = function (form) {
        ...
        if (this.isNewPhoto) {
            ...
            this.imagesService.uploadImage(body, _models_image_image_type__WEBPACK_IMPORTED_MODULE_11__["ImageType"].Avatar)
                ...
                return _this.authService.patchProfile(form);
            }))
                .subscribe(function (user) {
                _this.sessionStorage.updateUserInfo(user);
                _this.onSaveClick();
            });
        }
        else {
            this.authService.patchProfile(form)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(function (user) { return (Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["iif"])(function () { return !_this.photo.getValue() && !!user.avatar; }, _this.authService.deletePhoto(), Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(user))); }))
                .subscribe(function (user) {
                _this.sessionStorage.updateUserInfo(user);
                _this.onSaveClick();
            });
    ...
    ProfileEditComponent.prototype.onPhotoDelete = function () {
        this.photo.next(undefined);
        this.isNewPhoto = false;
    };
    ProfileEditComponent.prototype.onCancelClick = function () {
        this.onSaveClick();
        this.photo.next(undefined);
    };
    ProfileEditComponent.prototype.changePhotoHandler = function (file) {
        var _this = this;
        ...
        img.onload = function () {
            if (img.width < 150 || img.height < 150) {
                _this.toastrService.pop('error', 'Minimum size of avatar should be 150x150');
                return;
            }
            var fileReader = new FileReader();
            fileReader.onload = function () {
                var dialogRef = _this.modalService.show(_components_modals_image_crop_image_crop_component__WEBPACK_IMPORTED_MODULE_9__["ImageCropComponent"], {
                    initialState: {
    ...
    ProfileEditComponent.prototype.ngOnChanges = function (_a) {
...
var ProfileInfoComponent = /** @class */ (function () {
    function ProfileInfoComponent(authService, translate, sessionStorage, avatarService, usersService, activatedRoute) {
        this.authService = authService;
        ...
        var countriesList = activatedRoute.snapshot.data.countriesList;
    ...
    ProfileInfoComponent.prototype.initForm = function (user) {
    ...
    ProfileInfoComponent.prototype.ngOnDestroy = function () {
        this.subscriptions.unsubscribe();
    };
    ProfileInfoComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subscriptions.add(this.profileForm.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (form) { return !form.isComposer && !!form.idCode; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function () {
            _this.profileForm.controls.idCode.setValue(undefined);
            _this.profileForm.controls.idCode.markAsDirty();
        }))
            .subscribe());
    };
    ProfileInfoComponent.prototype.onEditClick = function () {
...
var ProfileOrdersComponent = /** @class */ (function () {
    function ProfileOrdersComponent(ordersService, usersService, httpClient, document, activatedRoute, router) {
    ...
    ProfileOrdersComponent.prototype.ngOnInit = function () {
        ...
        this.filterChanges = this.activatedRoute
            .queryParamMap
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (paramMap) {
            var offset = paramMap.has('offset') ? parseInt(paramMap.get('offset'), 10) : _this.offset;
            var limit = paramMap.has('limit') ? parseInt(paramMap.get('limit'), 10) : _this.limit;
            _this.pageIndex = offset / limit + 1;
    ...
    ProfileOrdersComponent.prototype.onSaveClick = function (filePath) {
    ...
    ProfileOrdersComponent.ctorParameters = function () { return [
...
var ProfileSellsheetsComponent = /** @class */ (function () {
    function ProfileSellsheetsComponent() {
    }
    ...
    return ProfileSellsheetsComponent;
}());
...
var ProfileSettingsComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ProfileSettingsComponent, _super);
    function ProfileSettingsComponent(translate, toasterService, changeDetectorRef, authService) {
        var _this = _super.call(this) || this;
    ...
    ProfileSettingsComponent.prototype.submit = function (form) {
        var _this = this;
        this.submitBtnDissabled.next(true);
        this.authService.changePassword(form)
            .subscribe(function () {
            _this.toasterService.pop('success', 'Password changed successffuly!');
            _this.submitBtnDissabled.next(false);
            Object(_core_helpers_form_helper__WEBPACK_IMPORTED_MODULE_8__["resetForm"])(_this.settingsForm);
            _this.changeDetectorRef.detectChanges();
        }, function () { return _this.submitBtnDissabled.next(false); });
    };
    ProfileSettingsComponent.prototype.initForm = function () {
...
}(_core_classes_form_base__WEBPACK_IMPORTED_MODULE_7__["FormBase"]));
...
var ProfileSubscriptionComponent = /** @class */ (function () {
    function ProfileSubscriptionComponent(router, activatedRoute, sessionsStorage) {
        this.router = router;
        this.activatedRoute = activatedRoute;
    ...
    ProfileSubscriptionComponent.prototype.handleOption = function ( /*optionSelected*/) {
        this.router.navigate(['/subscription/checkout']);
    };
    ProfileSubscriptionComponent.prototype.updateUserSubscribed = function () {
    ...
    ProfileSubscriptionComponent.prototype.subscriptionCheckboxChange = function () {
        this.subscriptionCheckbox.next(!this.subscriptionCheckbox.getValue());
    };
    ProfileSubscriptionComponent.ctorParameters = function () { return [
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(activatedRoute) {
        ...
        var activeObservable = this.activatedRoute.queryParams
            .subscribe(function (params) {
            var active = params.active;
            if (active !== undefined && !!parseInt(active, 10)) {
                _this.activeTab.next(parseInt(active, 10));
            }
        });
        this.subscription.add(activeObservable);
    }
    Object.defineProperty(ProfileComponent.prototype, "active", {
        get: function () {
...
/* harmony import */ var _ngx_formly_bootstrap__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ngx-formly/bootstrap */ "./node_modules/@ngx-formly/bootstrap/fesm5/ngx-formly-bootstrap.js");
