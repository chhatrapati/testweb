...
var VerificationComponent = /** @class */ (function () {
    function VerificationComponent(verificationsService, router, sessionsStorage, activatedRoute) {
    ...
    VerificationComponent.prototype.verifyUser = function () {
        ...
        this.verificationsService.verify(this.token, this.email)
            ...
            var data = _a.data;
            _this.sessionsStorage.store(data);
            _this.failed.next(false);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["delay"])(2000))
            .subscribe(function () { return _this.router.navigate(['/complete-profile']); }, function () { return _this.router.navigate(['/sign-up']); });
    };
...
//# sourceMappingURL=views-verification-verification-module-es5.js.map