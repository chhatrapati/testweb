...
var SearchItemComponent = /** @class */ (function () {
    ...
    Object.defineProperty(SearchItemComponent.prototype, "instruments", {
        get: function () {
            if (!this.songsheet ||
            ...
            var contentToShow = this.songsheet.instruments;
    ...
    Object.defineProperty(SearchItemComponent.prototype, "genres", {
        get: function () {
            if (!this.songsheet ||
            ...
            var contentToShow = this.songsheet.genres;
            var contentToShowLength = contentToShow.length;
            return (contentToShowLength <= 4
                ? contentToShow
                : contentToShow.slice(0, 4).concat('and more')).join(' · ');
    ...
    SearchItemComponent.prototype.onBuyClick = function (id) {
        this.router.navigate(['/music-scores', id]);
    };
    SearchItemComponent.prototype.onShowClick = function (id) {
...
var SongsheetsService = /** @class */ (function () {
    function SongsheetsService(apiUrl, httpClient) {
        this.apiUrl = apiUrl;
        this.httpClient = httpClient;
        this.endpoint = '/songsheets';
    }
    Object.defineProperty(SongsheetsService.prototype, "apiEndpoint", {
        get: function () {
    ...
    SongsheetsService.prototype.topList = function (filters) {
        ...
        return this.httpClient
            .get(this.apiEndpoint + '/top', { params: params })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (_a) {
            var data = _a.data, pagination = _a.pagination;
            return {
                data: data.map(function (s) { return new _models_songsheet_songsheet_model__WEBPACK_IMPORTED_MODULE_5__["SongsheetModel"](s); }),
    ...
    SongsheetsService.prototype.findList = function (filter) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        Object.keys(filter).forEach(function (key) {
            if (Array.isArray(filter[key])) {
                filter[key].forEach(function (item, index) {
                    params = params.append(key + "[" + index + "]", filter[key][index]);
                });
                delete filter[key];
            }
            else if (key === 'order') {
                Object.keys(filter[key]).forEach(function (item) {
        ...
        return this.httpClient
            .get(this.apiEndpoint + "/search", { params: params })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (_a) {
            var data = _a.data, pagination = _a.pagination;
            return {
                pagination: pagination,
                items: data.items.map(function (i) { return new _models_songsheet_songsheet_model__WEBPACK_IMPORTED_MODULE_5__["SongsheetModel"](i); }),
                itemsCount: data.itemsCount
            };
        }), 
        // ignore error
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])({ items: [], pagination: { totalCount: 0 } }); }));
    };
    SongsheetsService.prototype.getSongsheet = function (songsheetId) {
        return this.httpClient
            .get(this.apiEndpoint + "/" + songsheetId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) { return new _models_songsheet_songsheet_model__WEBPACK_IMPORTED_MODULE_5__["SongsheetModel"](response.data); }));
    };
    SongsheetsService.ctorParameters = function () { return [
...
//# sourceMappingURL=default~views-home-home-module~views-songsheets-songsheets-module-es5.js.map