...
let FacebookLoginService = class FacebookLoginService {
    constructor(fb) {
        this.fb = fb;
    ...
    getToken() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["defer"])(() => this.fb.login(loginOptions));
    }
    getUser() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["defer"])(() => this.fb.api('me?fields=id,name,email'));
    }
    signOut() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["defer"])(() => this.fb.logout());
    }
};
FacebookLoginService.ctorParameters = () => [
...
let GoogleLoginService = class GoogleLoginService {
    constructor(http, googleAuthService) {
        this.http = http;
        this.googleAuthService = googleAuthService;
    }
    getAuth() {
        return this.googleAuthService.getAuth()
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(auth => Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(auth.signIn())));
    }
};
...
let SocialService = class SocialService {
    ...
    facebookLogin(token) {
        return this.httpClient
            .post(`${this.apiEndpoint}/sessions/facebook`, { token })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => new _core_session_app_user__WEBPACK_IMPORTED_MODULE_5__["AppUser"](Object.assign(response.data.user, response.data.session))));
    }
    googleLogin(token) {
        return this.httpClient
            .post(`${this.apiEndpoint}/sessions/google`, { token })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => new _core_session_app_user__WEBPACK_IMPORTED_MODULE_5__["AppUser"](Object.assign(response.data.user, response.data.session))));
    }
    complete(role, email) {
        let params = {
...
let FormComponent = class FormComponent extends _core_classes_form_base__WEBPACK_IMPORTED_MODULE_9__["FormBase"] {
    constructor(usersService, translate, verificationsService, domsanitizer) {
        super();
...
//# sourceMappingURL=views-sign-up-sign-up-module-es2015.js.map