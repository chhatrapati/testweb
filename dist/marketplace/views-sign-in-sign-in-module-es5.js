...
var IsAuthGuard = /** @class */ (function () {
    function IsAuthGuard(sessionStorage, router) {
...
var SignInComponent = /** @class */ (function () {
    function SignInComponent(authService, sessionStorage, activatedRoute, translateService, router) {
    ...
    SignInComponent.prototype.submit = function (data) {
        ...
        this.authService.signIn(data)
            ...
            _this.sessionStorage.store(response);
            return _this.authService.getProfile();
        }))
            .subscribe(function (response) {
            var userData = _this.sessionStorage.restore();
            var songsheetId = _this.activatedRoute.snapshot.queryParams.songsheet;
            _this.sessionStorage.store(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, userData, response));
            if (!!songsheetId && parseInt(songsheetId, 10)) {
                _this.router.navigate(['/music-scores', parseInt(songsheetId, 10)]);
            }
            else {
    ...
    return [
        {
            ...
            expressionProperties: {
                'templateOptions.label': function () { return translator.instant('SignIn.Form.EmailLabel'); },
                'templateOptions.placeholder': function () { return translator.instant('SignIn.Form.EmailPlaceholder'); }
            },
            validation: {
                messages: {
        ...
        },
        {
            ...
            expressionProperties: {
                'templateOptions.label': function () { return translator.instant('SignIn.Form.PasswordLabel'); }
            },
            validation: {
                messages: {
...
//# sourceMappingURL=views-sign-in-sign-in-module-es5.js.map