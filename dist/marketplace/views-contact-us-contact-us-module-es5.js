...
var SystemService = /** @class */ (function () {
    function SystemService(apiUrl, httpClient) {
        this.apiUrl = apiUrl;
        this.httpClient = httpClient;
        this.endpoint = '/system/contact-us';
    }
    Object.defineProperty(SystemService.prototype, "apiEndpoint", {
        get: function () {
    ...
    SystemService.prototype.postContactForm = function (payload) {
        return this.httpClient
            .post(this.apiEndpoint, payload)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return data.data.message; }));
    };
...
var ContactUsComponent = /** @class */ (function () {
    function ContactUsComponent(toasterService, changeDetectionRef, systemService, translationService) {
    ...
    ContactUsComponent.prototype.submit = function (form) {
        ...
        this.systemService.postContactForm(form)
            ...
            _this.toasterService.pop('success', message);
            Object(_core_helpers_form_helper__WEBPACK_IMPORTED_MODULE_7__["resetForm"])(_this.contactUsForm);
...
function getFields(translator) {
    return [
        ...
        },
        {
            ...
            validators: {
                email: function (ctrl) { return _app_constants__WEBPACK_IMPORTED_MODULE_1__["EMAIL_PATTERN"].test(ctrl.value); }
            },
