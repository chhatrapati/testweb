...
var PaymentsService = /** @class */ (function () {
    function PaymentsService(apiUrl, sanitizer, httpClient) {
        this.apiUrl = apiUrl;
        this.sanitizer = sanitizer;
        this.httpClient = httpClient;
        this.endpoint = '/payments';
    }
    Object.defineProperty(PaymentsService.prototype, "apiEndpoint", {
        get: function () {
            return [this.apiUrl, this.endpoint].join('');
        },
        enumerable: true,
    ...
    PaymentsService.prototype.paySubscription = function (payload) {
        return this.httpClient
            .post(this.apiEndpoint + "/subscribe", payload);
    };
    PaymentsService.prototype.payCart = function (payload) {
        var _this = this;
        var url = [this.apiUrl, 'cart', 'payment'].join('/');
        return this.httpClient
            .post(url, payload)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return data.data.message; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (html) { return _this.sanitizer.bypassSecurityTrustHtml(html); }));
    };
        ...
        if (this.checkout) {
            ...
            if (this.isCartFree) {
                ...
                this.cartService.payFreeCart()
                    .subscribe(function (paymentDetails) {
...
var CheckoutComponent = /** @class */ (function () {
    function CheckoutComponent(activatedRoute, paymentService, toasterService, document, orderService, changeDetector, sessionStorage, authService, cartService) {
        var _this = this;
        ...
        var _a = activatedRoute.snapshot.data, countriesList = _a.countriesList, page = _a.page;
        this.countriesList = countriesList;
        this.page = page;
        this.cart = cartService.cart;
        this.cart.subscribe(function (val) {
            if (val) {
                _this.totalAmount = val.totalAmount;
            }
        });
        this.initForm();
    ...
    Object.defineProperty(CheckoutComponent.prototype, "startDate", {
        get: function () {
            return Date.now();
        },
        enumerable: true,
    ...
    Object.defineProperty(CheckoutComponent.prototype, "endDate", {
        get: function () {
    ...
    CheckoutComponent.prototype.onCartPayment = function () {
        var _this = this;
        var payload = this.handlePaymentFormData();
        this.paymentService.payCart(payload)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (html) { return _this.paymentHtml.next(html); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["delay"])(0, rxjs_internal_scheduler_animationFrame__WEBPACK_IMPORTED_MODULE_7__["animationFrame"]))
            .subscribe(function () {
            var htmlForm = document.getElementById('frmHtmlCheckout');
            if (htmlForm) {
    ...
    CheckoutComponent.prototype.onSubscriptionPayment = function () {
        var _this = this;
        var payload = this.handlePaymentFormData();
        this.paymentService.paySubscription(payload)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () { return _this.authService.getProfile(); }))
            .subscribe(function (u) {
            _this.sessionStorage.updateUserInfo(u);
            _this.purchasingStatus.next(true);
        }, function () {
            _this.toasterService.pop('error', 'Something went wrong');
        });
    };
    CheckoutComponent.prototype.handlePaymentFormData = function () {
        var _a = this.paymentForm.value, firstName = _a.firstName, lastName = _a.lastName, cvv = _a.cvv, cardNumber = _a.cardNumber, expirationMM = _a.expirationMM, expirationYY = _a.expirationYY;
        var _b = this.billingForm.value, country = _b.country, city = _b.city, address = _b.address, zip = _b.zip, state = _b.state;
        var countryDetails = this.countriesList.find(function (c) { return c.name === country; });
        return {
            firstName: firstName,
            lastName: lastName,
            city: city,
    ...
    CheckoutComponent.prototype.handleCartPaymentResponse = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["combineLatest"])(this.cartService.cart, this.activatedRoute.queryParams)
            ...
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), cart = _b[0], params = _b[1];
            ...
            var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), cart = _b[0], params = _b[1];
            var orderId = params['order-id'];
            var message = params['message'];
            if (orderId) {
                _this.orderService.getOrderById(orderId)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (paymentDetails) {
                    return (!!paymentDetails.status && paymentDetails.status.includes('Successfull'));
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (paymentDetails) { return _this.purchasingStatus.next(paymentDetails); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () { return _this.orderService.downloadOrderSongsheets(orderId); }))
            ...
            if (message) {
                _this.toasterService.pop('error', message);
            }
        });
    };
    ...
    return [
        {
            ...
            validation: {
                messages: {
                    required: function () { return 'First name field is empty'; },
                    maxlength: function () { return 'First name must be from 1 to 30 symbols'; },
                    pattern: function () { return 'First name can contain only alphanumeric and punctuation characters'; }
                }
            }
        },
        {
            ...
            validation: {
                messages: {
                    required: function () { return 'Last name field is empty'; },
                    maxlength: function () { return 'Last name must be from 1 to 30 symbols'; },
                    pattern: function () { return 'Last name can contain only alphanumeric and punctuation characters'; }
                }
            }
        },
        {
            ...
            validators: {
                value: function (ctrl) { return _app_constants__WEBPACK_IMPORTED_MODULE_0__["CARD_NUMBER_PATTERN"].test(ctrl.value); },
                minLength: function (ctrl) { return !!ctrl.value && !(ctrl.value.toString().length < 14); },
                maxLength: function (ctrl) { return !!ctrl.value && !(ctrl.value.toString().length > 19); }
            },
            validation: {
                messages: {
                    required: function () { return 'Card number field is empty'; },
                    maxLength: function () { return 'Card number doesn’t meet length validation criteria'; },
                    minLength: function () { return 'Card number doesn’t meet length validation criteria'; },
                    value: function () { return 'Card number does not exist'; },
                }
            }
        },
        {
            ...
            fieldGroup: [
                {
                    ...
                    validators: {
                        required: function () { return 'Expiration date field is empty'; },
                    },
                },
                {
                    key: 'slash',
                ...
                },
                {
                    ...
                    templateOptions: {
                        ...
                        hideRequiredMarker: true,
                        options: new Array(11).fill(Object(_core_helpers_form_helper__WEBPACK_IMPORTED_MODULE_1__["getCurrentYearLastDigits"])()).map(function (x, y) {
                            var n = x + y;
                ...
                },
                {
                    ...
                    validation: {
                        messages: {
                            required: function () { return 'CSC/CVV field is empty'; },
                            minlength: function () { return 'CSC/CVV doesn’t meet length validation criteria'; },
                            maxlength: function () { return 'CSC/CVV doesn’t meet length validation criteria'; },
                            pattern: function () { return 'CSC/CVV can contain only numeric characters'; }
                        }
                    }
                },
            ]
    ...
    return [
        {
            ...
            validation: {
                messages: {
                    ...
                    pattern: function () { return 'Address can contain only alphanumeric and punctuation characters'; }
                }
            }
        },
        {
        ...
        },
        {
            ...
            validation: {
                messages: {
                    ...
                    pattern: function () { return 'City can contain only alphanumeric characters'; }
                }
            }
        },
        {
            ...
            fieldGroup: [
                {
                    ...
                    validation: {
                        messages: {
                            minlength: function () { return 'State must be from 2 to 5 symbols'; },
                            maxlength: function () { return 'State must be from 2 to 5 symbols'; },
                            pattern: function () { return 'State can contain only alphanumeric characters'; }
                        }
                    }
                },
                {
                    ...
                    validation: {
                        messages: {
                            minlength: function () { return 'ZIP-code must be from 1 to 10 symbols'; },
                            maxlength: function () { return 'ZIP-code must be from 1 to 10 symbols'; },
                            pattern: function () { return 'Zip can contain only numeric characters'; }
                        }
                    }
                },
            ]
...
var ThanksPurchasingCartComponent = /** @class */ (function () {
    function ThanksPurchasingCartComponent(sessionStorage) {
        this.sessionStorage = sessionStorage;
        this.user = sessionStorage.userChanges;
    }
    ThanksPurchasingCartComponent.ctorParameters = function () { return [
    ...
    return ThanksPurchasingCartComponent;
}());
...
var ThanksPurchasingSubscriptionComponent = /** @class */ (function () {
    function ThanksPurchasingSubscriptionComponent(router) {
        var _this = this;
        this.router = router;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(2500)
            .subscribe(function () { return (_this.router.navigate(['/profile'], { queryParams: { active: _core_enums_profile_tabs_enum__WEBPACK_IMPORTED_MODULE_4__["ProfileTabs"].Subscription } })); });
    }
    ThanksPurchasingSubscriptionComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    ...
    return ThanksPurchasingSubscriptionComponent;
}());
...
//# sourceMappingURL=default~views-cart-cart-module~views-subscription-subscription-module-es5.js.map