(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-sign-up-sign-up-module"],{

/***/ "./node_modules/raw-loader/index.js!./src/app/views/sign-up/form/form.component.html":
/*!**********************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/views/sign-up/form/form.component.html ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"authentication-wrapper w-100 h-100 overflow-auto\">\n    <div class=\"authentication-container\" [class.wider]=\"isSuccessful | async\">\n        <div content class=\"w-100\">\n            <div class=\"row h-100\">\n                <div *ngIf=\"!(isSuccessful | async)\" class=\"col-lg-12\">\n                    <div toolbar>\n                        <h2 class=\"h2 font-bold text-center\">{{ 'SignUp.Title' | translate }}</h2>\n                        <div class=\"have-account text-center\">\n                            <span>{{ 'SignUp.HaveAccount' | translate }}</span>\n                            <a routerLink=\"/sign-in\">{{ 'SignUp.SignInHere' | translate }}</a>\n                        </div>\n                    </div>\n                    <form [formGroup]=\"form\" (ngSubmit)=\"submit(model)\">\n                        <formly-form [form]=\"form\" [fields]=\"fields\" [model]=\"model\">\n                            <button type=\"submit\" [disabled]=\"!form.valid || (submitBtnDissabled | async)\" class=\"btn btn-primary block full-width m-b\">\n                                {{ 'SignUp.Register' | translate }}\n                            </button>\n                        </formly-form>\n                    </form>\n                </div>\n                <div *ngIf=\"(isSuccessful | async)\" class=\"col-lg-12 verify-email-text-block message-with-note h-100\">\n                    <div class=\"key-note__wr\">\n                        <img class=\"key-note\" [src]=\"icKeyNote\" alt=\"key note\">\n                    </div>\n                    <div class=\"signup-verify-text text-center\">\n                        {{ 'SignUp.VerifyText' | translate }}\n                    </div>\n                    <div class=\"signup-check-inbox text-center\">\n                        {{ 'SignUp.CheckInboxText' | translate }}\n                    </div>\n                    <a class=\"btn btn-sm btn-block good-btn\" href=\"/\">{{ 'SignUp.ResendBtn' | translate }}</a>\n                </div>\n            </div>\n\n        </div>\n    </div>\n</div>\n"
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FacebookLoginService", function() { return FacebookLoginService; });
...
var FacebookLoginService = /** @class */ (function () {
    function FacebookLoginService(fb) {
        this.fb = fb;
        this.fb.init(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["FacebookSocialConfig"]);
    }
    FacebookLoginService.prototype.getToken = function () {
        var _this = this;
        var loginOptions = {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["defer"])(function () { return _this.fb.login(loginOptions); });
    };
    FacebookLoginService.prototype.getUser = function () {
        var _this = this;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["defer"])(function () { return _this.fb.api('me?fields=id,name,email'); });
    };
    FacebookLoginService.prototype.signOut = function () {
        var _this = this;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["defer"])(function () { return _this.fb.logout(); });
    };
    FacebookLoginService.ctorParameters = function () { return [
        { type: ngx_facebook__WEBPACK_IMPORTED_MODULE_2__["FacebookService"] }
    ]; };
    FacebookLoginService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_facebook__WEBPACK_IMPORTED_MODULE_2__["FacebookService"]])
...
/*!********************************************!*\
  !*** ./src/app/services/google.service.ts ***!
  \********************************************/
/*! exports provided: GoogleLoginService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var ng_gapi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ng-gapi */ "./node_modules/ng-gapi/lib/index.js");
...
var GoogleLoginService = /** @class */ (function () {
    function GoogleLoginService(http, googleAuthService) {
        this.http = http;
        this.googleAuthService = googleAuthService;
    }
    GoogleLoginService.prototype.getAuth = function () {
        return this.googleAuthService.getAuth()
            .pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (auth) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(auth.signIn()); }));
    };
    GoogleLoginService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: ng_gapi__WEBPACK_IMPORTED_MODULE_3__["GoogleAuthService"] }
    ]; };
    GoogleLoginService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], ng_gapi__WEBPACK_IMPORTED_MODULE_3__["GoogleAuthService"]])
    ], GoogleLoginService);
...
/* harmony import */ var _core_session_app_user__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../core/session/app-user */ "./src/app/core/session/app-user.ts");
...
var SocialService = /** @class */ (function () {
    function SocialService(apiUrl, httpClient) {
        this.apiUrl = apiUrl;
        this.httpClient = httpClient;
        this.endpoint = '/socials';
    }
    Object.defineProperty(SocialService.prototype, "apiEndpoint", {
        get: function () {
    ...
    SocialService.prototype.facebookLogin = function (token) {
        return this.httpClient
            .post(this.apiEndpoint + "/sessions/facebook", { token: token })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return new _core_session_app_user__WEBPACK_IMPORTED_MODULE_5__["AppUser"](Object.assign(response.data.user, response.data.session)); }));
    };
    SocialService.prototype.googleLogin = function (token) {
        return this.httpClient
            .post(this.apiEndpoint + "/sessions/google", { token: token })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return new _core_session_app_user__WEBPACK_IMPORTED_MODULE_5__["AppUser"](Object.assign(response.data.user, response.data.session)); }));
    };
    SocialService.prototype.complete = function (role, email) {
        var params = {
            role: role,
        };
        if (email) {
        ...
        return this.httpClient
            .put(this.apiEndpoint + "/sessions", params)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return new _core_session_app_user__WEBPACK_IMPORTED_MODULE_5__["AppUser"](Object.assign(response.data.user, response.data.session)); }));
    };
...
/***/ "./src/app/views/sign-up/form/form.component.scss":
/*!********************************************************!*\
  !*** ./src/app/views/sign-up/form/form.component.scss ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "/* VARIABLES */\n/* MIXINS */\n/* CLASS VARIABLES*/\n.message-with-note {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n/* BASE STYLES */\n.btn {\n  height: 50px;\n  border-radius: 25px;\n  padding-left: 30px;\n  padding-right: 30px;\n  font-family: Montserrat, sans-serif;\n  font-size: 14px;\n  font-weight: 900;\n  letter-spacing: 2.66px;\n  text-align: center;\n  text-transform: uppercase;\n  transition: all ease-in 300ms;\n}\n.btn-primary {\n  background-color: #ee4036;\n  border-color: #ee4036;\n  color: #ffffff;\n}\n.btn-primary:hover {\n  background-color: #393e41;\n  border-color: #393e41;\n}\n.btn-secondary {\n  background-color: #393e41;\n  border-color: #393e41;\n}\n.btn-secondary:hover {\n  background-color: #ee4036;\n  border-color: #ee4036;\n}\n.btn-white {\n  color: #a0a0a0;\n  border: 3px solid #a0a0a0;\n}\n.btn-white:hover {\n  border-width: 3px;\n}\n.btn-icon {\n  width: 20px;\n  height: 20px;\n  padding: 0;\n}\n.spacer {\n  flex: 1 1 auto;\n}\n.hidden, [hidden] {\n  display: none !important;\n}\na {\n  line-height: 1.43;\n  color: #393e41;\n  transition: color ease-in-out 200ms;\n}\na:hover {\n  color: #ee4036;\n}\n.text-ellipsis {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.delimiter {\n  height: 1px;\n  background-color: #ececec;\n  margin: 30px -15px;\n}\n.card {\n  display: flex;\n  flex-direction: row;\n  padding: 15px;\n  box-shadow: 0 5px 50px -25px rgba(0, 0, 0, 0.25);\n}\n/* Custom margins */\n.mt-30 {\n  margin-top: 30px;\n}\n.mt-40 {\n  margin-top: 40px;\n}\n.mt-50 {\n  margin-top: 50px;\n}\n.mt-60 {\n  margin-top: 60px;\n}\n/* Custom paddings */\n.p-rl-10 {\n  padding: 0 10px;\n}\n.p-rl-25 {\n  padding: 0 25px;\n}\n/* VARIABLES */\n/* MIXINS */\n/* CLASS VARIABLES*/\n.message-with-note {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n/* BASE STYLES */\n.btn {\n  height: 50px;\n  border-radius: 25px;\n  padding-left: 30px;\n  padding-right: 30px;\n  font-family: Montserrat, sans-serif;\n  font-size: 14px;\n  font-weight: 900;\n  letter-spacing: 2.66px;\n  text-align: center;\n  text-transform: uppercase;\n  transition: all ease-in 300ms;\n}\n.btn-primary {\n  background-color: #ee4036;\n  border-color: #ee4036;\n  color: #ffffff;\n}\n.btn-primary:hover {\n  background-color: #393e41;\n  border-color: #393e41;\n}\n.btn-secondary {\n  background-color: #393e41;\n  border-color: #393e41;\n}\n.btn-secondary:hover {\n  background-color: #ee4036;\n  border-color: #ee4036;\n}\n.btn-white {\n  color: #a0a0a0;\n  border: 3px solid #a0a0a0;\n}\n.btn-white:hover {\n  border-width: 3px;\n}\n.btn-icon {\n  width: 20px;\n  height: 20px;\n  padding: 0;\n}\n.spacer {\n  flex: 1 1 auto;\n}\n.hidden, [hidden] {\n  display: none !important;\n}\na {\n  line-height: 1.43;\n  color: #393e41;\n  transition: color ease-in-out 200ms;\n}\na:hover {\n  color: #ee4036;\n}\n.text-ellipsis {\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.delimiter {\n  height: 1px;\n  background-color: #ececec;\n  margin: 30px -15px;\n}\n.card {\n  display: flex;\n  flex-direction: row;\n  padding: 15px;\n  box-shadow: 0 5px 50px -25px rgba(0, 0, 0, 0.25);\n}\n/* Custom margins */\n.mt-30 {\n  margin-top: 30px;\n}\n.mt-40 {\n  margin-top: 40px;\n}\n.mt-50 {\n  margin-top: 50px;\n}\n.mt-60 {\n  margin-top: 60px;\n}\n/* Custom paddings */\n.p-rl-10 {\n  padding: 0 10px;\n}\n.p-rl-25 {\n  padding: 0 25px;\n}\n.authentication.wider {\n  width: 410px;\n}\n.authentication-wrapper {\n  background-color: #ffffff;\n}\n.authentication-container {\n  margin: 2% auto 60px auto;\n  width: 371px;\n  background-color: #ffffff;\n}\n@media (max-width: 576px) {\n  .authentication-container {\n    width: 300px;\n  }\n}\n@media (max-width: 377px) {\n  .authentication-container {\n    width: 277px;\n  }\n}\n.h2 {\n  margin-bottom: 60px;\n  font-family: Avenir, sans-serif;\n  font-size: 32px;\n  font-weight: 600;\n  color: #393e41;\n}\n.below-auth {\n  font-size: 14px;\n  margin-top: 20px;\n  line-height: 1.43;\n  color: #999999;\n}\n.message-with-note {\n  position: relative;\n  min-height: 410px;\n}\n.message-with-note > *:not(.key-note__wr) {\n  z-index: 2;\n}\n.message-with-note .h2 {\n  margin-bottom: 15px;\n}\n.message-with-note .text {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 1.5;\n  text-align: center;\n  color: #a0a0a0;\n}\n.key-note {\n  width: 160px;\n  height: 410px;\n}\n.key-note__wr {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  z-index: 1;\n}\n.h2 {\n  margin-bottom: 20px;\n}\n.have-account {\n  font-size: 14px;\n  font-weight: 500;\n  margin-bottom: 20px;\n}\n.have-account span {\n  color: #999999;\n  margin-right: 10px;\n}\n.have-account a {\n  color: #393e41;\n}\n.signup-verify-text {\n  font-size: 32px;\n  font-weight: 600;\n  line-height: 38px;\n  color: #393e41;\n  font-family: Avenir;\n  margin-bottom: 15px;\n}\n.signup-check-inbox {\n  color: #a0a0a0;\n  font-size: 16px;\n  font-weight: 400;\n  margin-bottom: 25px;\n}\n.good-btn {\n  height: 56px;\n  width: 155px;\n  border-radius: 28px;\n  background-color: #ee4036;\n  color: #ffffff !important;\n  padding-top: 16px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/views/sign-up/form/form.component.ts":
/*!******************************************************!*\
  !*** ./src/app/views/sign-up/form/form.component.ts ***!
  \******************************************************/
...
/* harmony import */ var _form_configs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./form.configs */ "./src/app/views/sign-up/form/form.configs.ts");
...
/* harmony import */ var _services_verifications_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../services/verifications.service */ "./src/app/services/verifications.service.ts");
...
var FormComponent = /** @class */ (function (_super) {
    ...
    function FormComponent(usersService, translate, verificationsService, domsanitizer) {
        var _this = _super.call(this) || this;
        _this.usersService = usersService;
        _this.translate = translate;
        _this.verificationsService = verificationsService;
        _this.domsanitizer = domsanitizer;
        _this.isSuccessful = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](false);
        _this.icKeyNote = '/assets/img/ic-key-note-light-gray.svg';
        _this.initForm();
        return _this;
    }
    FormComponent.prototype.initForm = function () {
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({});
        this.model = Object(_form_configs__WEBPACK_IMPORTED_MODULE_6__["getModel"])();
        this.fields = Object(_form_configs__WEBPACK_IMPORTED_MODULE_6__["getFields"])(this.translate, this.domsanitizer);
    };
    FormComponent.prototype.submit = function (data) {
        ...
        this.usersService
            .signUp(postData)
            .subscribe(function () {
            _this.isSuccessful.next(true);
            _this.submitBtnDissabled.next(false);
        }, function () {
            _this.submitBtnDissabled.next(false);
        });
    };
    FormComponent.prototype.setState = function (email) {
        this.userEmail = email;
        if (this.userEmail) {
            this.isSuccessful.next(true);
        }
    };
    FormComponent.prototype.resend = function () {
    ...
    FormComponent.ctorParameters = function () { return [
        ...
        { type: _services_verifications_service__WEBPACK_IMPORTED_MODULE_8__["VerificationsService"] },
        { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"] }
    ]; };
    FormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-sign-up',
            template: __webpack_require__(/*! raw-loader!./form.component.html */ "./node_modules/raw-loader/index.js!./src/app/views/sign-up/form/form.component.html"),
            changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
            styles: [__webpack_require__(/*! ../../../../styles/shared/auth.styles.scss */ "./src/styles/shared/auth.styles.scss"), __webpack_require__(/*! ./form.component.scss */ "./src/app/views/sign-up/form/form.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_users_service__WEBPACK_IMPORTED_MODULE_7__["UsersService"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"],
            _services_verifications_service__WEBPACK_IMPORTED_MODULE_8__["VerificationsService"],
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["DomSanitizer"]])
    ], FormComponent);
    return FormComponent;
}(_core_classes_form_base__WEBPACK_IMPORTED_MODULE_9__["FormBase"]));



/***/ }),

/***/ "./src/app/views/sign-up/form/form.configs.ts":
/*!****************************************************!*\
  !*** ./src/app/views/sign-up/form/form.configs.ts ***!
  \****************************************************/
...
/* harmony import */ var _validation_emailRFC821__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../validation/emailRFC821 */ "./src/app/validation/emailRFC821.ts");




function getFields(translator, domSanitizer) {
    return [
        {
            key: 'name',
            type: 'input',
        ...
        },
        {
            ...
            validation: {
                messages: {
                    minlength: function () { return translator.instant('Validation.Common.EmailLength'); },
                    maxlength: function () { return translator.instant('Validation.Common.EmailLength'); },
                    email: function () { return translator.instant('Validation.Common.Email'); },
                }
            },
            validators: {
                validation: _validation_emailRFC821__WEBPACK_IMPORTED_MODULE_3__["emailRFC821"]
            },
        },
        {
            key: 'password',
            validators: {
                fieldMatch: {
                    ...
                    message: function () { return translator.instant('Validation.Common.PasswordsDontMatch'); },
            ...
            fieldGroup: [
                {
                    ...
                    templateOptions: {
                        ...
                        required: true,
                        hideRequiredMarker: true,
                        minLength: _app_constants__WEBPACK_IMPORTED_MODULE_2__["PASSWORD_MIN_LENGTH"],
                        maxLength: _app_constants__WEBPACK_IMPORTED_MODULE_2__["PASSWORD_MAX_LENGTH"],
                        pattern: _app_constants__WEBPACK_IMPORTED_MODULE_2__["PASSWORD_PATTERN"]
                    },
                    validation: {
                        messages: {
                            pattern: function () { return translator.instant('Validation.Common.Password'); },
                            minlength: function () { return translator.instant('Validation.Common.PassLength'); },
                            maxlength: function () { return translator.instant('Validation.Common.PassLength'); },
                        }
                    }
                },
                {
        ...
        },
        {
            ...
            validators: {
                validation: [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].requiredTrue]
            },
        },
        {
            key: 'checkbox-label',
            ...
            template: "<span>" + domSanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_1__["SecurityContext"].HTML, 'Read and accept <a href="/terms-and-conditions">Terms & Conditions</a> ' +
...
/***/ "./src/app/views/sign-up/sign-up.module.ts":
/*!*************************************************!*\
  !*** ./src/app/views/sign-up/sign-up.module.ts ***!
  \*************************************************/
...
/* harmony import */ var _form_form_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./form/form.component */ "./src/app/views/sign-up/form/form.component.ts");
/* harmony import */ var _sign_up_router__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./sign-up.router */ "./src/app/views/sign-up/sign-up.router.ts");
...
/* harmony import */ var _services_verifications_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../services/verifications.service */ "./src/app/services/verifications.service.ts");
/* harmony import */ var src_app_libs_view_container_view_container_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/libs/view-container/view-container.module */ "./src/app/libs/view-container/view-container.module.ts");
...
/* harmony import */ var _services_social_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../services/social.service */ "./src/app/services/social.service.ts");
/* harmony import */ var _services_google_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../services/google.service */ "./src/app/services/google.service.ts");
    ...
    SignUpModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(_sign_up_router__WEBPACK_IMPORTED_MODULE_9__["SignUpRouter"]),
                src_app_libs_view_container_view_container_module__WEBPACK_IMPORTED_MODULE_12__["ViewContainerModule"]
            ],
            providers: [
                _services_users_service__WEBPACK_IMPORTED_MODULE_10__["UsersService"],
                _services_facebook_service__WEBPACK_IMPORTED_MODULE_13__["FacebookLoginService"],
                _services_google_service__WEBPACK_IMPORTED_MODULE_15__["GoogleLoginService"],
                _services_verifications_service__WEBPACK_IMPORTED_MODULE_11__["VerificationsService"],
                _services_social_service__WEBPACK_IMPORTED_MODULE_14__["SocialService"]
            ],
            declarations: [_form_form_component__WEBPACK_IMPORTED_MODULE_8__["FormComponent"]]
        })
    ], SignUpModule);
    return SignUpModule;
}());
...
/***/ "./src/app/views/sign-up/sign-up.router.ts":
/*!*************************************************!*\
  !*** ./src/app/views/sign-up/sign-up.router.ts ***!
  \*************************************************/
/*! exports provided: SignUpRouter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SignUpRouter", function() { return SignUpRouter; });
/* harmony import */ var _form_form_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form/form.component */ "./src/app/views/sign-up/form/form.component.ts");
...
//# sourceMappingURL=views-sign-up-sign-up-module-es5.js.map