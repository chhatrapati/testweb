...
var PasswordResetComponent = /** @class */ (function () {
    function PasswordResetComponent(verificationsService, translate) {
    ...
    PasswordResetComponent.prototype.initForm = function () {
    ...
    PasswordResetComponent.prototype.submit = function (data) {
        var _this = this;
        this.verificationsService.reset(data.email)
            .subscribe(function () { return _this.isSuccessful.next(true); });
    };
...
//# sourceMappingURL=views-reset-password-reset-password-module-es5.js.map